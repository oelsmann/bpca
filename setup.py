...
DISTNAME = "bpca"
DESCRIPTION = "Bayesian Principal Component Analysis to model spatiotemporal data from GNSS, 'altimetry minus tide gauge' and other geophysical time series."
AUTHOR = "Julius Oelsmann"
AUTHOR_EMAIL = "julius.oelsmann@tum.com"
URL = "https://github.com/oelsmann/bpca"
...
def get_version():
    VERSIONFILE = join("bpca", "__init__.py")
